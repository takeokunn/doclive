...
また、文書本文から生成された =href= / =src= / =xlink:href= / =formaction= は、相対リンク・アンカー・=http:= / =https:= / =mailto:= だけを保持し、その他の scheme、protocol-relative URL、バックスラッシュ、制御文字を含むURLは DOM 挿入前に削除します。
